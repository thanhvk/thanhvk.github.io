...
.controller('QuestionQuizInterviewController', function($scope, $employer, $rootScope, localStorageService, $location, $common, $q,$cache,_)
{
    ...
    $scope.addOption = function(title) {
        var option = {title:title,correct:false};
