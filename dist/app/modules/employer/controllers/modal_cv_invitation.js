'use strict';
angular.module('employerModule').controller('ModalCvInvitationController', function($scope,$rootScope,$translate,localStorageService, $location, $common, $q, blockUI, $employee,$uibModalInstance, $employer, candidate, _, toastr) {
    ...
    $scope.avatar = '' ;
    $scope.eduLevelsList = [];
    $scope.chooseEmployee = candidate;
