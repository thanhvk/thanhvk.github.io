'use strict';
angular.module('employerModule').controller('EmployeeCvController', function($scope,$rootScope,$translate,localStorageService, $location, $common, $q, $employee,$uibModalInstance, candidate, _) {
